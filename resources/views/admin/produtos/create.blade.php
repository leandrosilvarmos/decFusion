...
<form method="POST" enctype="multipart/form-data" action="{{route('produtos.store')}}">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-5">
            <input type="text" class="form-control @error('modelo') is-invalid @enderror" name="modelo" value="{{old('modelo')}}" placeholder="Modelo">
    ...
    <div class="row mt-4 mb-4">
        ...
        <div class="form-group col-md-4">
            <input type="text" class="form-control @error('sku') is-invalid @enderror" name="sku" placeholder="Sku Produto">
